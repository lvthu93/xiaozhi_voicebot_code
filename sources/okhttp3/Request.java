    ...
    public static class Builder {
        ...
        public Builder method(String str, RequestBody requestBody) {
            if (str == null) {
                ...
                throw new IllegalArgumentException(y2.j("method ", str, " must not have a request body."));
            } else if (requestBody != null || !HttpMethod.requiresRequestBody(str)) {
                this.method = str;
                this.body = requestBody;
                return this;
            } else {
                throw new IllegalArgumentException(y2.j("method ", str, " must have a request body."));
            }
        }
