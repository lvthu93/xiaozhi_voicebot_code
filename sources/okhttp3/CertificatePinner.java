...
public final class CertificatePinner {
    ...
    public static final class Pin {
        ...
        public Pin(String str, String str2) {
            ...
            if (str2.startsWith("sha1/")) {
                ...
                this.hash = cq.d(str2.substring(5));
            } else if (str2.startsWith("sha256/")) {
                this.hashAlgorithm = "sha256/";
                this.hash = cq.d(str2.substring(7));
            } else {
    ...
    public static cq sha1(X509Certificate x509Certificate) {
        return cq.q(x509Certificate.getPublicKey().getEncoded()).i("SHA-1");
    }

    public static cq sha256(X509Certificate x509Certificate) {
        return cq.q(x509Certificate.getPublicKey().getEncoded()).i("SHA-256");
    }
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (pin.hashAlgorithm.equals("sha256/")) {
                        if (cqVar == null) {
                            cqVar = sha256(x509Certificate);
                        }
                        if (pin.hash.equals(cqVar)) {
                            return;
                        }
                    } else if (pin.hashAlgorithm.equals("sha1/")) {
                        if (cqVar2 == null) {
                            cqVar2 = sha1(x509Certificate);
                        }
                        if (pin.hash.equals(cqVar2)) {
                            return;
                        }
                    } else {
    ...
    public int hashCode() {
        ...
        return this.pins.hashCode() + (i * 31);
    }
