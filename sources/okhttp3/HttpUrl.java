...
public final class HttpUrl {
    ...
    public static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i4 < i3) {
            ...
            int i5 = i;
            ckVar.ap(i, i4, str);
            canonicalize(ckVar, str, i4, i2, str2, z, z2, z3, z4, charset);
            return ckVar.ae();
        }
        int i6 = i;
    ...
    public static final class Builder {
        ...
        public Builder port(int i) {
            if (i <= 0 || i > 65535) {
                throw new IllegalArgumentException(y2.f("unexpected port: ", i));
            }
            this.port = i;
            return this;
        }
    ...
    public static String percentDecode(String str, int i, int i2, boolean z) {
        for (int i3 = i; i3 < i2; i3++) {
            ...
            if (charAt == '%' || (charAt == '+' && z)) {
                ck ckVar = new ck();
                ckVar.ap(i, i3, str);
                percentDecode(ckVar, str, i3, i2, z);
                return ckVar.ae();
            }
        }
        return str.substring(i, i2);
    ...
    public static void canonicalize(ck ckVar, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ck ckVar2 = null;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    String str3 = z ? MqttTopic.SINGLE_LEVEL_WILDCARD : "%2B";
                    ckVar.getClass();
                    ckVar.ap(0, str3.length(), str3);
                    ...
                    if (charset == null || charset.equals(Util.UTF_8)) {
                        ckVar2.aq(codePointAt);
                    } else {
                        ckVar2.ao(str, i, Character.charCount(codePointAt) + i, charset);
                    }
                    while (!ckVar2.g()) {
                        byte readByte = ckVar2.readByte() & 255;
                        ckVar.ai(37);
                        char[] cArr = HEX_DIGITS;
                        ckVar.ai(cArr[(readByte >> 4) & 15]);
                        ckVar.ai(cArr[readByte & 15]);
                    }
                } else {
                    ckVar.aq(codePointAt);
                }
            }
    ...
    public static void percentDecode(ck ckVar, String str, int i, int i2, boolean z) {
        int i3;
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (codePointAt == 37 && (i3 = i + 2) < i2) {
                ...
                if (!(decodeHexDigit == -1 || decodeHexDigit2 == -1)) {
                    ckVar.ai((decodeHexDigit << 4) + decodeHexDigit2);
                    i = i3;
                    i += Character.charCount(codePointAt);
                }
