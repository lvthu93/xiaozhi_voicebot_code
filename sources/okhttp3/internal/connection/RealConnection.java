...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = new da(s7.b(this.rawSocket));
                this.sink = new z9(s7.a(this.rawSocket));
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        ...
        L_0x00f3:
            ...
            jb r8 = defpackage.s7.b(r1)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            da r0 = new da     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            ...
            za r8 = defpackage.s7.a(r8)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            z9 r0 = new z9     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
            r0.<init>(r8)     // Catch:{ AssertionError -> 0x0125, all -> 0x0122 }
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            jb newFixedLengthSource = http1Codec.newFixedLengthSource(contentLength);
            Util.skipAll(newFixedLengthSource, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, timeUnit);
    ...
    public void connect(int r17, int r18, int r19, int r20, boolean r21, okhttp3.Call r22, okhttp3.EventListener r23) {
        ...
        L_0x0046:
            ...
            java.lang.String r0 = defpackage.y2.j(r3, r0, r4)
            r2.<init>(r0)
            r1.<init>(r2)
            throw r1
        L_0x0059:
