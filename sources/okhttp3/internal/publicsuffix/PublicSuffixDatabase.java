...
public final class PublicSuffixDatabase {
    ...
    private void readTheList() throws IOException {
        ...
        if (resourceAsStream != null) {
            Logger logger = s7.a;
            da daVar = new da(new p3(new p7(resourceAsStream, new lc())));
            try {
                byte[] bArr = new byte[daVar.readInt()];
                daVar.readFully(bArr);
                byte[] bArr2 = new byte[daVar.readInt()];
                daVar.readFully(bArr2);
                synchronized (this) {
                ...
                Util.closeQuietly((Closeable) daVar);
            }
        }
    }
