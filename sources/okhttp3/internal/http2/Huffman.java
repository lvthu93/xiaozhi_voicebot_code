...
class Huffman {
    ...
    public void encode(defpackage.cq r8, defpackage.cl r9) throws java.io.IOException {
        /*
            r7 = this;
            r0 = 0
            r2 = 0
        ...
        L_0x003a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.http2.Huffman.encode(cq, cl):void");
    }

    public int encodedLength(cq cqVar) {
        long j = 0;
        for (int i = 0; i < cqVar.t(); i++) {
            j += (long) CODE_LENGTHS[cqVar.n(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
