...
public final class p extends C0037a implements Serializable {
    ...
    static {
        p pVar = new p();
        o = pVar;
        C0037a.E(pVar, "Hijrah");
        C0037a.E(pVar, "islamic");
    }
    ...
    private void T() {
        if (!this.f) {
            ...
            try {
                ...
                int[][] c0 = c0();
                int F = (int) LocalDate.of(1882, 11, 12).F();
                int i2 = 1300;
                while (i2 <= 1600) {
                    int[] iArr = c0[i2 - 1300];
                    if (iArr.length == 12) {
                ...
                } else if (!this.e.equals("islamic-umalqura")) {
                ...
                throw new DateTimeException("Unable to initialize HijrahCalendar: " + str, e2);
            }
        }
    }

    private int[] U(int i2, HashMap hashMap) {
        int[] iArr = new int[3613];
        this.k = ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
        this.l = Integer.MIN_VALUE;
        int i3 = 0;
        for (int i4 = 1300; i4 <= 1600; i4++) {
            int[] iArr2 = (int[]) hashMap.get(Integer.valueOf(i4));
            int i5 = 0;
            while (i5 < 12) {
                int i6 = iArr2[i5];
                int i7 = i3 + 1;
        ...
        throw new IllegalStateException("Did not fill epochMonths exactly: ndx = " + i8 + " should be " + 3613);
    }
    ...
    public final C0039c B(TemporalAccessor temporalAccessor) {
        return temporalAccessor instanceof r ? (r) temporalAccessor : r.W(this, temporalAccessor.E(a.EPOCH_DAY));
    }
    ...
    public final C0039c K(int i2, int i3, int i4) {
        return r.V(this, i2, i3, i4);
    }
    ...
    public final boolean O(long j2) {
        T();
        return j2 >= ((long) Z()) && j2 <= ((long) Y()) && b0((int) j2) > 354;
    }
    ...
    public final int[] X(int i2) {
        ...
        int binarySearch = Arrays.binarySearch(this.g, i2);
        if (binarySearch < 0) {
            binarySearch = (-binarySearch) - 2;
        }
        int i3 = this.j;
        return new int[]{(binarySearch + i3) / 12, ((i3 + binarySearch) % 12) + 1, (i2 - this.g[binarySearch]) + 1};
    }
    ...
    public final int b0(int i2) {
        int i3 = (i2 * 12) - this.j;
        int[] iArr = this.g;
        return iArr[12 + i3] - iArr[i3];
    }

    public final C0039c i(long j2) {
        return r.W(this, j2);
    }
    ...
    public final C0039c m() {
        ...
        return b0 instanceof r ? (r) b0 : r.W(this, b0.E(a.EPOCH_DAY));
    }
    ...
    public final C0039c o(int i2, int i3) {
        r V = r.V(this, i2, 1, 1);
        if (i3 <= V.M()) {
            return V.R((long) (i3 - 1));
        }
    ...
    public final u s(a aVar) {
        ...
        switch (o.a[aVar.ordinal()]) {
            case 1:
                return u.k(1, (long) this.k, (long) this.l);
            case 2:
                return u.j(1, (long) this.n);
            case 3:
                return u.j(1, 5);
            case 4:
            case 5:
                return u.j((long) Z(), (long) Y());
            case 6:
                return u.j(1, 1);
            default:
                return aVar.m();
    ...
    public final C0039c v(HashMap hashMap, E e2) {
        return (r) super.v(hashMap, e2);
    }
