...
public class WebSocketImpl implements WebSocket {
    ...
    private void decodeFrames(ByteBuffer byteBuffer) {
        try {
            for (Framedata next : this.draft.translateFrame(byteBuffer)) {
                this.log.d(next, "matched frame: {}");
                this.draft.processFrame(this, next);
            }
        } catch (LimitExceededException e) {
            if (e.getLimit() == Integer.MAX_VALUE) {
                this.log.c("Closing due to invalid size of frame", e);
                this.wsl.onWebsocketError(this, e);
            }
            close((InvalidDataException) e);
        } catch (InvalidDataException e2) {
            this.log.c("Closing due to invalid data in frame", e2);
            this.wsl.onWebsocketError(this, e2);
            close(e2);
        } catch (LinkageError | ThreadDeath | VirtualMachineError e3) {
            this.log.a("Got fatal error during frame processing");
            throw e3;
        } catch (Error e4) {
            this.log.a("Closing web socket due to an error during frame processing");
            this.wsl.onWebsocketError(this, new Exception(e4));
            close(1011, "Got error ".concat(e4.getClass().getName()));
        }
    }
        ...
        try {
            ...
            if (role2 == Role.SERVER) {
                ...
                if (draft2 == null) {
                    for (Draft copyInstance : this.knownDrafts) {
                        ...
                        try {
                            ...
                            if (!(translateHandshake instanceof ClientHandshake)) {
                                this.log.i("Closing due to wrong handshake");
                            ...
                            if (copyInstance2.acceptHandshakeAsServer(clientHandshake) == HandshakeState.MATCHED) {
                                ...
                                try {
                                    ...
                                    this.log.h("Closing due to wrong handshake. Possible handshake rejection", e);
                                    closeConnectionDueToWrongHandshake(e);
                                    return false;
                                } catch (RuntimeException e2) {
                                    this.log.c("Closing due to internal server error", e2);
                                    this.wsl.onWebsocketError(this, e2);
                    ...
                    if (this.draft == null) {
                        this.log.i("Closing due to protocol error: no draft matches");
                ...
                if (!(translateHandshake2 instanceof ClientHandshake)) {
                    this.log.i("Closing due to protocol error: wrong http function");
                ...
                this.log.i("Closing due to protocol error: the handshake did finally not match");
                close(1002, "the handshake did finally not match");
                return false;
            }
            if (role2 == Role.CLIENT) {
                this.draft.setParseMode(role2);
                ...
                if (this.draft.acceptHandshakeAsClient(this.handshakerequest, serverHandshake) == HandshakeState.MATCHED) {
                    try {
                        ...
                        this.log.h("Closing due to invalid data exception. Possible handshake rejection", e3);
                        flushAndClose(e3.getCloseCode(), e3.getMessage(), false);
                        return false;
                    } catch (RuntimeException e4) {
                        this.log.c("Closing since client was never connected", e4);
                        this.wsl.onWebsocketError(this, e4);
                        flushAndClose(-1, e4.getMessage(), false);
                        return false;
                    }
                } else {
                    this.log.d(this.draft, "Closing due to protocol error: draft {} refuses handshake");
            ...
            try {
                this.log.h("Closing due to invalid handshake", e5);
    ...
    private void open(Handshakedata handshakedata) {
        this.log.d(this.draft, "open using draft: {}");
    ...
    private void write(ByteBuffer byteBuffer) {
        this.log.f("write({}): {}", Integer.valueOf(byteBuffer.remaining()), byteBuffer.remaining() > 1000 ? "too big to display" : new String(byteBuffer.array()));
    ...
    public synchronized void close(int r6, java.lang.String r7, boolean r8) {
        /*
            r5 = this;
            monitor-enter(r5)
            org.java_websocket.enums.ReadyState r0 = r5.readyState     // Catch:{ all -> 0x0084 }
            org.java_websocket.enums.ReadyState r1 = org.java_websocket.enums.ReadyState.CLOSING     // Catch:{ all -> 0x0084 }
            if (r0 == r1) goto L_0x0082
            org.java_websocket.enums.ReadyState r0 = r5.readyState     // Catch:{ all -> 0x0084 }
            org.java_websocket.enums.ReadyState r2 = org.java_websocket.enums.ReadyState.CLOSED     // Catch:{ all -> 0x0084 }
            if (r0 == r2) goto L_0x0082
            org.java_websocket.enums.ReadyState r0 = r5.readyState     // Catch:{ all -> 0x0084 }
            org.java_websocket.enums.ReadyState r2 = org.java_websocket.enums.ReadyState.OPEN     // Catch:{ all -> 0x0084 }
            r3 = 0
            if (r0 != r2) goto L_0x0065
            r0 = 1006(0x3ee, float:1.41E-42)
            if (r6 != r0) goto L_0x001f
            r5.readyState = r1     // Catch:{ all -> 0x0084 }
            r5.flushAndClose(r6, r7, r3)     // Catch:{ all -> 0x0084 }
            monitor-exit(r5)
            return
        L_0x001f:
            org.java_websocket.drafts.Draft r1 = r5.draft     // Catch:{ all -> 0x0084 }
            org.java_websocket.enums.CloseHandshakeType r1 = r1.getCloseHandshakeType()     // Catch:{ all -> 0x0084 }
            org.java_websocket.enums.CloseHandshakeType r2 = org.java_websocket.enums.CloseHandshakeType.NONE     // Catch:{ all -> 0x0084 }
            if (r1 == r2) goto L_0x0061
            if (r8 != 0) goto L_0x0037
            org.java_websocket.WebSocketListener r1 = r5.wsl     // Catch:{ RuntimeException -> 0x0031 }
            r1.onWebsocketCloseInitiated(r5, r6, r7)     // Catch:{ RuntimeException -> 0x0031 }
            goto L_0x0037
        L_0x0031:
            r1 = move-exception
            org.java_websocket.WebSocketListener r2 = r5.wsl     // Catch:{ InvalidDataException -> 0x004f }
            r2.onWebsocketError(r5, r1)     // Catch:{ InvalidDataException -> 0x004f }
        L_0x0037:
            boolean r1 = r5.isOpen()     // Catch:{ InvalidDataException -> 0x004f }
            if (r1 == 0) goto L_0x0061
            org.java_websocket.framing.CloseFrame r1 = new org.java_websocket.framing.CloseFrame     // Catch:{ InvalidDataException -> 0x004f }
            r1.<init>()     // Catch:{ InvalidDataException -> 0x004f }
            r1.setReason(r7)     // Catch:{ InvalidDataException -> 0x004f }
            r1.setCode(r6)     // Catch:{ InvalidDataException -> 0x004f }
            r1.isValid()     // Catch:{ InvalidDataException -> 0x004f }
            r5.sendFrame((org.java_websocket.framing.Framedata) r1)     // Catch:{ InvalidDataException -> 0x004f }
            goto L_0x0061
        L_0x004f:
            r1 = move-exception
            k4 r2 = r5.log     // Catch:{ all -> 0x0084 }
            java.lang.String r4 = "generated frame is invalid"
            r2.c(r4, r1)     // Catch:{ all -> 0x0084 }
            org.java_websocket.WebSocketListener r2 = r5.wsl     // Catch:{ all -> 0x0084 }
            r2.onWebsocketError(r5, r1)     // Catch:{ all -> 0x0084 }
            java.lang.String r1 = "generated frame is invalid"
            r5.flushAndClose(r0, r1, r3)     // Catch:{ all -> 0x0084 }
        L_0x0061:
            r5.flushAndClose(r6, r7, r8)     // Catch:{ all -> 0x0084 }
            goto L_0x0079
        L_0x0065:
            r0 = -3
            if (r6 != r0) goto L_0x006d
            r6 = 1
            r5.flushAndClose(r0, r7, r6)     // Catch:{ all -> 0x0084 }
            goto L_0x0079
        L_0x006d:
        ...
        L_0x0075:
            ...
            r5.flushAndClose(r6, r7, r3)     // Catch:{ all -> 0x0084 }
        L_0x0079:
            org.java_websocket.enums.ReadyState r6 = org.java_websocket.enums.ReadyState.CLOSING     // Catch:{ all -> 0x0084 }
            r5.readyState = r6     // Catch:{ all -> 0x0084 }
            r6 = 0
            r5.tmpHandshakeBytes = r6     // Catch:{ all -> 0x0084 }
            monitor-exit(r5)
            return
        L_0x0082:
            monitor-exit(r5)
            ...
            if (byteChannel != null) {
                try {
                    ...
                    if (e.getMessage() == null || !e.getMessage().equals("Broken pipe")) {
                        this.log.c("Exception during channel.close()", e);
                        this.wsl.onWebsocketError(this, e);
                    } else {
                        this.log.h("Caught IOException: Broken pipe during closeConnection()", e);
                    }
                }
            }
            try {
    ...
    public synchronized void flushAndClose(int i, String str, boolean z) {
        if (!this.flushandclosestate) {
            ...
            try {
                ...
                this.log.c("Exception in onWebsocketClosing", e);
                this.wsl.onWebsocketError(this, e);
            }
            Draft draft2 = this.draft;
            if (draft2 != null) {
    ...
    public IProtocol getProtocol() {
        ...
        if (draft2 instanceof Draft_6455) {
            return ((Draft_6455) draft2).getProtocol();
        }
    ...
    public void startHandshake(ClientHandshakeBuilder clientHandshakeBuilder) throws InvalidHandshakeException {
        ...
        try {
            ...
            this.log.c("Exception in startHandshake", e);
            this.wsl.onWebsocketError(this, e);
    ...
    public WebSocketImpl(WebSocketListener webSocketListener, Draft draft2) {
        this.log = l4.e(WebSocketImpl.class);
