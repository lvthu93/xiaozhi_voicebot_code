...
public abstract class FramedataImpl1 implements Framedata {
    ...
    public int hashCode() {
        int i;
        int hashCode = (this.optcode.hashCode() + ((this.fin ? 1 : 0) * true)) * 31;
        ByteBuffer byteBuffer = this.unmaskedpayload;
        if (byteBuffer != null) {
        ...
        return ((((((((hashCode + i) * 31) + (this.transferemasked ? 1 : 0)) * 31) + (this.rsv1 ? 1 : 0)) * 31) + (this.rsv2 ? 1 : 0)) * 31) + (this.rsv3 ? 1 : 0);
    }
