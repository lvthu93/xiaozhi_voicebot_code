...
public class NativeInt8Array extends NativeTypedArrayView<Byte> {
    ...
    public NativeInt8Array construct(NativeArrayBuffer nativeArrayBuffer, int i, int i2) {
    ...
    public NativeInt8Array realThis(Scriptable scriptable, IdFunctionObject idFunctionObject) {
