...
public class NativeUint8ClampedArray extends NativeTypedArrayView<Integer> {
    ...
    public NativeUint8ClampedArray construct(NativeArrayBuffer nativeArrayBuffer, int i, int i2) {
    ...
    public NativeUint8ClampedArray realThis(Scriptable scriptable, IdFunctionObject idFunctionObject) {
