...
public class NativeInt32Array extends NativeTypedArrayView<Integer> {
    ...
    public Object js_get(int i) {
        ...
        return ByteIo.readInt32(this.arrayBuffer.buffer, (i * 4) + this.offset, NativeArrayBufferView.useLittleEndian());
    }
    ...
    public NativeInt32Array construct(NativeArrayBuffer nativeArrayBuffer, int i, int i2) {
    ...
    public NativeInt32Array realThis(Scriptable scriptable, IdFunctionObject idFunctionObject) {
