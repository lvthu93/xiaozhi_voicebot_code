...
public class SwitchGenerator {
    ...
    private static boolean bigger(IdValuePair idValuePair, IdValuePair idValuePair2, int i) {
        if (i < 0) {
            ...
            if (i2 != 0) {
                ...
                return false;
            } else if (idValuePair.id.compareTo(idValuePair2.id) > 0) {
                return true;
            } else {
                return false;
            }
    ...
    private EvaluatorException on_same_pair_fail(IdValuePair idValuePair, IdValuePair idValuePair2) {
        ...
        return this.R.runtimeError(ToolErrorReporter.getMessage("msg.idswitch.same_string", idValuePair.id, Integer.valueOf(lineNumber)), this.source_file, i, (String) null, 0);
    }
