...
public class Main {
    ...
    private int extract_line_tag_id(char[] cArr, int i, int i2) {
        ...
        if (look_for_slash_slash != i2) {
            if (skip_white_space2 + 2 == look_for_slash_slash) {
                z = true;
            } else {
                z = false;
            }
            ...
            if (skip_white_space3 != i2 && cArr[skip_white_space3] == '#') {
                ...
                if (!(i5 == i2 || (skip_white_space = skip_white_space(cArr, i5, i2)) == i2 || (((c = cArr[skip_white_space]) != '=' && c != '#') || (i3 = get_tag_id(cArr, i4, i5, z)) == 0))) {
                    String str = null;
                    if (c == '#') {
                        if (z2) {
                            i3 = -i3;
    ...
    private int get_tag_id(char[] cArr, int i, int i2, boolean z) {
        ...
        if (equals(STRING_TAG_STR, cArr, i, i2)) {
            return 3;
        }
        return 0;
    }
    ...
    private int process_options(java.lang.String[] r14) {
        ...
        L_0x003a:
            ...
            java.lang.String r0 = org.mozilla.javascript.tools.ToolErrorReporter.getMessage((java.lang.String) r0, (java.lang.String) r6)
            r13.option_error(r0)
            goto L_0x0067
        L_0x0044:
            r8 = 1
        L_0x0045:
            ...
            java.lang.String r0 = org.mozilla.javascript.tools.ToolErrorReporter.getMessage((java.lang.String) r0, (java.lang.String) r2)
            r13.option_error(r0)
            goto L_0x0067
        L_0x005d:
            int r8 = r8 + 1
    ...
    private void process_file() {
        ...
        L_0x0049:
            ...
            r14.look_for_id_definitions(r0, r8, r9, r11)
            goto L_0x008f
        L_0x0050:
        ...
        L_0x0090:
            ...
            goto L_0x0012
        L_0x0094:
            java.lang.String r0 = "msg.idswitch.bad_tag_order"
            java.lang.String r1 = tag_name(r10)
            java.lang.String r3 = org.mozilla.javascript.tools.ToolErrorReporter.getMessage((java.lang.String) r0, (java.lang.String) r1)
        ...
        L_0x00af:
            ...
            return
        L_0x00b2:
            java.lang.String r0 = "msg.idswitch.file_end_in_switch"
            java.lang.String r1 = tag_name(r3)
            java.lang.String r3 = org.mozilla.javascript.tools.ToolErrorReporter.getMessage((java.lang.String) r0, (java.lang.String) r1)
            org.mozilla.javascript.tools.ToolErrorReporter r2 = r14.R
            java.lang.String r4 = r14.source_file
            org.mozilla.javascript.tools.idswitch.FileBody r0 = r14.body
