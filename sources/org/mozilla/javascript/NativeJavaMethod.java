...
public class NativeJavaMethod extends BaseFunction {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:0x008c, code lost:
        if (r14.isPublic() == false) goto L_0x00a3;
     */
    ...
    public static int findFunction(org.mozilla.javascript.Context r16, org.mozilla.javascript.MemberBox[] r17, java.lang.Object[] r18) {
        ...
        L_0x0072:
            ...
            boolean r3 = r9.isPublic()
            if (r15 == r3) goto L_0x0092
            boolean r3 = r14.isPublic()
        ...
        L_0x0118:
            ...
            java.lang.String r0 = scriptSignature(r18)
    ...
    public static String scriptSignature(Object[] objArr) {
        ...
        for (int i = 0; i != objArr.length; i++) {
            ...
            } else if (wrapper instanceof Function) {
                str = "function";
            } else {
                str = "object";
            }
    ...
    public Object call(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        if (this.methods.length != 0) {
            ...
            throw Context.reportRuntimeError1("msg.java.no_such_method", declaringClass2.getName() + '.' + getFunctionName() + '(' + scriptSignature(objArr) + ')');
        }
