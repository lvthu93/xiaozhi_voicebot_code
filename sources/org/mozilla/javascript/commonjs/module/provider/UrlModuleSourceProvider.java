...
public class UrlModuleSourceProvider extends ModuleSourceProviderBase {
    ...
    public static class URLValidator implements Serializable {
        ...
        private static long calculateExpiry(URLConnection uRLConnection, long j, UrlConnectionExpiryCalculator urlConnectionExpiryCalculator) {
            ...
            if (headerField != null) {
                ...
                if (-1 != maxAge) {
                    ...
                    return (((long) maxAge) * 1000) + (currentTimeMillis - ((currentTimeMillis - j) + Math.max(Math.max(0, currentTimeMillis - uRLConnection.getDate()), ((long) uRLConnection.getHeaderFieldInt("Age", 0)) * 1000)));
                }
            }
        ...
        private static String getEntityTags(URLConnection uRLConnection) {
            List list = uRLConnection.getHeaderFields().get("ETag");
    ...
    public org.mozilla.javascript.commonjs.module.provider.ModuleSource loadFromActualUri(java.net.URI r13, java.net.URI r14, java.lang.Object r15) throws java.io.IOException {
        ...
        L_0x002d:
            ...
            org.mozilla.javascript.commonjs.module.provider.ModuleSource r13 = org.mozilla.javascript.commonjs.module.provider.ModuleSourceProvider.NOT_MODIFIED     // Catch:{ FileNotFoundException -> 0x0067, RuntimeException -> 0x0062, IOException -> 0x005d }
            return r13
        L_0x0040:
