...
public final class IRFactory extends Parser {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:31:0x013e A[LOOP:2: B:30:0x013c->B:31:0x013e, LOOP_END] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private org.mozilla.javascript.Node arrayCompTransformHelper(org.mozilla.javascript.ast.ArrayComprehension r20, java.lang.String r21) {
        /*
            r19 = this;
            r9 = r19
            org.mozilla.javascript.Decompiler r0 = r9.decompiler
            r1 = 84
            r0.addToken(r1)
            int r0 = r20.getLineno()
            org.mozilla.javascript.ast.AstNode r1 = r20.getResult()
            org.mozilla.javascript.Node r1 = r9.transform(r1)
            java.util.List r10 = r20.getLoops()
            int r2 = r10.size()
            org.mozilla.javascript.Node[] r11 = new org.mozilla.javascript.Node[r2]
            org.mozilla.javascript.Node[] r12 = new org.mozilla.javascript.Node[r2]
            r13 = 0
            r14 = r1
            r1 = 0
        L_0x0024:
            ...
            org.mozilla.javascript.Decompiler r7 = r9.decompiler
            r7.addName(r4)
            org.mozilla.javascript.Decompiler r4 = r9.decompiler
        ...
        L_0x004b:
            ...
            org.mozilla.javascript.Decompiler r5 = r9.decompiler
            r5.addName(r4)
            goto L_0x0084
        L_0x0066:
            r9.decompile(r4)
            org.mozilla.javascript.ast.ScriptNode r7 = r9.currentScriptOrFn
            java.lang.String r7 = r7.getNextTempName()
            r9.defineSymbol(r5, r7, r13)
            r5 = 91
            org.mozilla.javascript.Node r8 = r9.createName(r7)
            org.mozilla.javascript.Node r4 = r9.createAssignment(r5, r4, r8)
            r5 = 90
            org.mozilla.javascript.Node r4 = createBinary(r5, r4, r14)
            r14 = r4
            r4 = r7
        L_0x0084:
            org.mozilla.javascript.Node r5 = r9.createName(r4)
            r7 = 154(0x9a, float:2.16E-43)
            r9.defineSymbol(r7, r4, r13)
            r11[r1] = r5
            boolean r4 = r6.isForOf()
        ...
        L_0x00a4:
            ...
            org.mozilla.javascript.Node r4 = r9.transform(r4)
            r12[r1] = r4
            org.mozilla.javascript.Decompiler r4 = r9.decompiler
            r4.addToken(r3)
            int r1 = r1 + 1
        ...
        L_0x00b7:
            r1 = r21
            org.mozilla.javascript.Node r1 = r9.createName(r1)
            java.lang.String r6 = "push"
            r15 = 0
            org.mozilla.javascript.Node r1 = r9.createPropertyGet(r1, r15, r6, r13)
            r6 = 38
            org.mozilla.javascript.Node r8 = r9.createCallOrNew(r6, r1)
            org.mozilla.javascript.Node r1 = new org.mozilla.javascript.Node
            r6 = 134(0x86, float:1.88E-43)
            r1.<init>((int) r6, (org.mozilla.javascript.Node) r8, (int) r0)
            org.mozilla.javascript.ast.AstNode r6 = r20.getFilter()
            if (r6 == 0) goto L_0x00f9
            org.mozilla.javascript.Decompiler r6 = r9.decompiler
            r6.addName(r4)
            org.mozilla.javascript.Decompiler r4 = r9.decompiler
            ...
            org.mozilla.javascript.Decompiler r4 = r9.decompiler
            r4.addToken(r5)
            org.mozilla.javascript.ast.AstNode r4 = r20.getFilter()
            org.mozilla.javascript.Node r4 = r9.transform(r4)
            org.mozilla.javascript.Node r1 = createIf(r4, r1, r15, r0)
            org.mozilla.javascript.Decompiler r0 = r9.decompiler
            r0.addToken(r3)
        L_0x00f9:
            int r2 = r2 + -1
        ...
        L_0x00fe:
            ...
            java.lang.Object r2 = r10.get(r0)     // Catch:{ all -> 0x013a }
            org.mozilla.javascript.ast.ArrayComprehensionLoop r2 = (org.mozilla.javascript.ast.ArrayComprehensionLoop) r2     // Catch:{ all -> 0x013a }
            int r3 = r2.getLineno()     // Catch:{ all -> 0x013a }
            org.mozilla.javascript.ast.Scope r3 = r9.createLoopNode(r15, r3)     // Catch:{ all -> 0x013a }
            r9.pushScope(r3)     // Catch:{ all -> 0x013a }
            int r16 = r1 + 1
            r4 = 154(0x9a, float:2.16E-43)
            r5 = r11[r0]     // Catch:{ all -> 0x0136 }
            r7 = r12[r0]     // Catch:{ all -> 0x0136 }
            boolean r17 = r2.isForEach()     // Catch:{ all -> 0x0136 }
            boolean r18 = r2.isForOf()     // Catch:{ all -> 0x0136 }
            r1 = r19
            r2 = r4
            r4 = r5
            r5 = r7
            ...
            r13 = r8
            r8 = r18
            org.mozilla.javascript.Node r6 = r1.createForIn(r2, r3, r4, r5, r6, r7, r8)     // Catch:{ all -> 0x0136 }
            int r0 = r0 + -1
            r8 = r13
            r1 = r16
            r13 = 0
    ...
    private Node createAssignment(int i, Node node, Node node2) {
        ...
        if (makeReference != null) {
            ...
            if (type == 33 || type == 36) {
                ...
                return new Node(i3, firstChild, lastChild, new Node(i2, new Node(Token.USE_STACK), node2));
            } else if (type == 39) {
                ...
                return new Node((int) Token.SET_REF_OP, firstChild2, new Node(i2, new Node(Token.USE_STACK), node2));
            } else {
                throw Kit.codeBug();
            }
    ...
    private Node createCatch(String str, Node node, Node node2, int i) {
        ...
        return new Node(Token.CATCH, createName(str), node, node2, i);
    }
    ...
    private static Node createCondExpr(Node node, Node node2, Node node3) {
        ...
        return new Node(103, node, node2, node3);
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private org.mozilla.javascript.Node createForIn(int r20, org.mozilla.javascript.Node r21, org.mozilla.javascript.Node r22, org.mozilla.javascript.Node r23, org.mozilla.javascript.Node r24, boolean r25, boolean r26) {
        /*
            r19 = this;
            r0 = r19
            r1 = r22
            int r2 = r22.getType()
            r3 = 0
            java.lang.String r4 = "msg.bad.for.in.lhs"
        ...
        L_0x001a:
            ...
            goto L_0x002c
        L_0x001f:
            org.mozilla.javascript.Node r6 = makeReference(r22)
        ...
        L_0x002a:
            ...
            goto L_0x0067
        L_0x002c:
            boolean r3 = r1 instanceof org.mozilla.javascript.ast.ArrayLiteral
            if (r3 == 0) goto L_0x0037
            r3 = r1
            org.mozilla.javascript.ast.ArrayLiteral r3 = (org.mozilla.javascript.ast.ArrayLiteral) r3
            int r9 = r3.getDestructuringLength()
        L_0x0037:
            r6 = r1
            r12 = r2
            goto L_0x0067
        L_0x003a:
            org.mozilla.javascript.Node r11 = r22.getLastChild()
            int r12 = r11.getType()
        ...
        L_0x0047:
            ...
            java.lang.String r3 = r11.getString()
            org.mozilla.javascript.Node r3 = org.mozilla.javascript.Node.newString(r6, r3)
            r12 = r2
            r6 = r3
            goto L_0x002a
        L_0x0056:
            ...
            return r3
        L_0x005a:
            boolean r2 = r11 instanceof org.mozilla.javascript.ast.ArrayLiteral
            if (r2 == 0) goto L_0x0065
            r2 = r11
            org.mozilla.javascript.ast.ArrayLiteral r2 = (org.mozilla.javascript.ast.ArrayLiteral) r2
            int r9 = r2.getDestructuringLength()
        L_0x0065:
            r6 = r11
            r2 = r12
        L_0x0067:
        ...
        L_0x007f:
            ...
            r13 = r23
            r11.<init>((int) r4, (org.mozilla.javascript.Node) r13)
            r4 = 3
            r11.putProp(r4, r3)
            ...
            r8 = r20
            org.mozilla.javascript.Node r6 = r0.createDestructuringAssignment(r8, r6, r13)
        ...
        L_0x00b6:
            java.lang.String r2 = "msg.bad.for.in.destruct"
            r0.reportError(r2)
            goto L_0x00c0
        L_0x00bc:
            org.mozilla.javascript.Node r6 = r0.simpleAssignment(r6, r13)
        L_0x00c0:
            org.mozilla.javascript.Node r2 = new org.mozilla.javascript.Node
            r7 = 134(0x86, float:1.88E-43)
            r2.<init>((int) r7, (org.mozilla.javascript.Node) r6)
            r4.addChildToBack(r2)
            r2 = r24
            r4.addChildToBack(r2)
            r13 = r21
            org.mozilla.javascript.ast.Jump r13 = (org.mozilla.javascript.ast.Jump) r13
            r14 = 1
            r17 = 0
            r18 = 0
            r2 = r15
            r15 = r4
            r16 = r2
            org.mozilla.javascript.Node r2 = createLoop(r13, r14, r15, r16, r17, r18)
            r2.addChildToFront(r11)
            if (r12 == r10) goto L_0x00e7
            if (r12 != r5) goto L_0x00ea
        L_0x00e7:
            r2.addChildToFront(r1)
        L_0x00ea:
            r3.addChildToBack(r2)
            return r3
        */
    ...
    private Node createMemberRefGet(Node node, String str, Node node2, int i) {
        ...
        if (node != null) {
            if (str == null) {
                node5 = new Node(78, node, node2);
            } else {
                node5 = new Node(79, node, node3, node2);
            }
            node4 = node5;
        } else if (str == null) {
            node4 = new Node(80, node2);
        } else {
            node4 = new Node(81, node3, node2);
        }
        if (i != 0) {
    ...
    private Node createTryCatchFinally(Node node, Node node2, Node node3, int i) {
        ...
        Node node5 = node3;
        boolean z2 = false;
        if (node5 == null || (node3.getType() == 130 && !node3.hasChildren())) {
            z = false;
        } else {
            z = true;
        }
        if (node.getType() == 130 && !node.hasChildren() && !z) {
            return node4;
        }
        ...
        if (hasChildren) {
            ...
            jump.addChildToBack(newTarget2);
            Node node7 = new Node(Token.LOCAL_BLOCK);
        ...
        if (z) {
            ...
            jump.addChildToBack(newTarget3);
            Node node10 = new Node((int) Token.FINALLY, node5);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x0121 A[LOOP:2: B:26:0x011f->B:27:0x0121, LOOP_END] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private org.mozilla.javascript.Node genExprTransformHelper(org.mozilla.javascript.ast.GeneratorExpression r19) {
        /*
            r18 = this;
            r9 = r18
            org.mozilla.javascript.Decompiler r0 = r9.decompiler
            ...
            org.mozilla.javascript.ast.AstNode r2 = r19.getResult()
            org.mozilla.javascript.Node r2 = r9.transform(r2)
            java.util.List r10 = r19.getLoops()
            int r3 = r10.size()
            org.mozilla.javascript.Node[] r11 = new org.mozilla.javascript.Node[r3]
            org.mozilla.javascript.Node[] r12 = new org.mozilla.javascript.Node[r3]
            r13 = 0
            r4 = 0
        L_0x0023:
            java.lang.String r5 = " "
        ...
        L_0x0056:
            ...
            org.mozilla.javascript.ast.ScriptNode r7 = r9.currentScriptOrFn
            java.lang.String r7 = r7.getNextTempName()
            r9.defineSymbol(r1, r7, r13)
            r8 = 91
            org.mozilla.javascript.Node r15 = r9.createName(r7)
            org.mozilla.javascript.Node r5 = r9.createAssignment(r8, r5, r15)
            r8 = 90
            org.mozilla.javascript.Node r2 = createBinary(r8, r5, r2)
            r5 = r7
        L_0x0073:
            org.mozilla.javascript.Node r7 = r9.createName(r5)
            r8 = 154(0x9a, float:2.16E-43)
            r9.defineSymbol(r8, r5, r13)
            r11[r4] = r7
            boolean r5 = r6.isForOf()
        ...
        L_0x008c:
            ...
            r5.addToken(r7)
        L_0x0093:
            org.mozilla.javascript.ast.AstNode r5 = r6.getIteratedObject()
            org.mozilla.javascript.Node r5 = r9.transform(r5)
            r12[r4] = r5
            org.mozilla.javascript.Decompiler r5 = r9.decompiler
            r5.addToken(r14)
            int r4 = r4 + 1
        ...
        L_0x00a6:
            org.mozilla.javascript.Node r4 = new org.mozilla.javascript.Node
            r6 = 73
            int r7 = r19.getLineno()
            r4.<init>((int) r6, (org.mozilla.javascript.Node) r2, (int) r7)
            org.mozilla.javascript.Node r2 = new org.mozilla.javascript.Node
            r6 = 134(0x86, float:1.88E-43)
            r2.<init>((int) r6, (org.mozilla.javascript.Node) r4, (int) r0)
            ...
            org.mozilla.javascript.Decompiler r4 = r9.decompiler
            r4.addToken(r1)
            org.mozilla.javascript.ast.AstNode r1 = r19.getFilter()
            org.mozilla.javascript.Node r1 = r9.transform(r1)
            org.mozilla.javascript.Node r2 = createIf(r1, r2, r15, r0)
            org.mozilla.javascript.Decompiler r0 = r9.decompiler
            r0.addToken(r14)
        L_0x00e1:
            int r3 = r3 + -1
        ...
        L_0x00e6:
            ...
            java.lang.Object r2 = r10.get(r0)     // Catch:{ all -> 0x011e }
            org.mozilla.javascript.ast.GeneratorExpressionLoop r2 = (org.mozilla.javascript.ast.GeneratorExpressionLoop) r2     // Catch:{ all -> 0x011e }
            int r3 = r2.getLineno()     // Catch:{ all -> 0x011e }
            org.mozilla.javascript.ast.Scope r3 = r9.createLoopNode(r15, r3)     // Catch:{ all -> 0x011e }
            r9.pushScope(r3)     // Catch:{ all -> 0x011e }
            int r16 = r1 + 1
            r4 = 154(0x9a, float:2.16E-43)
            r5 = r11[r0]     // Catch:{ all -> 0x011a }
            r7 = r12[r0]     // Catch:{ all -> 0x011a }
            boolean r8 = r2.isForEach()     // Catch:{ all -> 0x011a }
            boolean r17 = r2.isForOf()     // Catch:{ all -> 0x011a }
            r1 = r18
            r2 = r4
            r4 = r5
            r5 = r7
            r7 = r8
            r8 = r17
            org.mozilla.javascript.Node r6 = r1.createForIn(r2, r3, r4, r5, r6, r7, r8)     // Catch:{ all -> 0x011a }
            int r0 = r0 + -1
            r1 = r16
            goto L_0x00e6
        L_0x011a:
    ...
    private static Node initFunction(FunctionNode functionNode, int i, Node node, int i2) {
        ...
        if (i2 == 2 && (functionName = functionNode.getFunctionName()) != null && functionName.length() != 0 && functionNode.getSymbol(functionName.getIdentifier()) == null) {
            functionNode.putSymbol(new Symbol(110, functionName.getIdentifier()));
    ...
    private Node transformArrayComp(ArrayComprehension arrayComprehension) {
        ...
        Scope createScopeNode = createScopeNode(Token.ARRAYCOMP, lineno);
    ...
    private Node transformLabeledStatement(LabeledStatement labeledStatement) {
        ...
        Node newTarget = Node.newTarget();
        Node node = new Node(130, (Node) firstLabel, transform, newTarget);
    ...
    private Node transformSwitch(SwitchStatement switchStatement) {
        ...
        Node node2 = new Node(130, (Node) switchStatement, switchStatement.getLineno());
        this.decompiler.addEOL(86);
    ...
    private Node transformTry(TryStatement tryStatement) {
        ...
        for (CatchClause next : tryStatement.getCatchClauses()) {
            ...
            if (catchCondition != null) {
                this.decompiler.addName(" ");
                this.decompiler.addToken(113);
                node2 = transform(catchCondition);
            } else {
            ...
            this.decompiler.addEOL(87);
            block.addChildToBack(createCatch(identifier, node2, transform2, next.getLineno()));
        }
    ...
    private Node transformXmlLiteral(XmlLiteral xmlLiteral) {
        ...
        node3.addChildToBack(createName(str));
        Node node4 = null;
        for (XmlFragment next : fragments) {
            if (next instanceof XmlString) {
                ...
                this.decompiler.addToken(87);
                if (isXmlAttribute) {
                    node2 = createBinary(21, createBinary(21, createString("\""), createUnary(76, node)), createString("\""));
                } else {
                    node2 = createUnary(77, node);
                }
