...
public final class YoutubeTrendingGamingVideosLinkHandlerFactory extends ListLinkHandlerFactory {
    public static final YoutubeTrendingGamingVideosLinkHandlerFactory a = new YoutubeTrendingGamingVideosLinkHandlerFactory();

    public String getId(String str) throws ParsingException, UnsupportedOperationException {
        return "trending_gaming";
    }
    ...
    public boolean onAcceptUrl(String str) {
        try {
            ...
            if ((YoutubeParsingHelper.isYoutubeURL(stringToURL) || YoutubeParsingHelper.isInvidiousURL(stringToURL)) && "/gaming/trending".equals(stringToURL.getPath())) {
                return true;
            }
            return false;
