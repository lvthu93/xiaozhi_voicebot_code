...
public class lc {
    public static final lc NONE = new a();
    ...
    public lc clearDeadline() {
        this.hasDeadline = false;
        return this;
    }

    public lc clearTimeout() {
        this.timeoutNanos = 0;
        return this;
    }

    public final lc deadline(long j, TimeUnit timeUnit) {
        if (j <= 0) {
            throw new IllegalArgumentException(y2.g("duration <= 0: ", j));
    ...
    public lc timeout(long j, TimeUnit timeUnit) {
        if (j < 0) {
            throw new IllegalArgumentException(y2.g("timeout < 0: ", j));
        } else if (timeUnit != null) {
    ...
    public lc deadlineNanoTime(long j) {
