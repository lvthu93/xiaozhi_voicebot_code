...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    ...
                    throw new IllegalStateException(y2.e(this.mRecyclerView, sb));
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(y2.e(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt != null) {
                ...
                if (findPositionOffset < 0 || findPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                    ...
                    throw new IndexOutOfBoundsException(y2.e(RecyclerView.this, sb));
                }
            ...
            throw new IllegalArgumentException(y2.e(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
        }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            if (i < 0 || i >= RecyclerView.this.mState.getItemCount()) {
                StringBuilder n = y2.n("invalid position ", i, ". State item count is ");
                n.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(y2.e(RecyclerView.this, n));
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            throw new IllegalStateException(y2.e(RecyclerView.this, sb));
        }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                sb.append(z2);
                throw new IllegalArgumentException(y2.e(RecyclerView.this, sb));
            } else if (viewHolder.isTmpDetached()) {
                StringBuilder sb2 = new StringBuilder("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
                sb2.append(viewHolder);
                throw new IllegalArgumentException(y2.e(RecyclerView.this, sb2));
                ...
                throw new IllegalArgumentException(y2.e(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(y2.e(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        }
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x00b2:
                ...
                java.lang.String r1 = defpackage.y2.e(r2, r1)
                r0.<init>(r1)
                throw r0
            L_0x00c5:
                java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(y2.e(this, sb));
                }
                StringBuilder sb2 = new StringBuilder("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:");
                sb2.append(childViewHolderInt);
                sb2.append(" \n View Holder 2:");
                sb2.append(viewHolder);
                throw new IllegalStateException(y2.e(this, sb2));
            }
        }
                    ...
                    if (i != 33) {
                        if (i != 66) {
                            if (i != 130) {
                                ...
                                sb.append(i);
                                throw new IllegalArgumentException(y2.e(this, sb));
                            } else if (c > 0) {
                                return true;
                            } else {
                                return false;
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(y2.e(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(y2.e(this, y2.m(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(y2.e(this, new StringBuilder("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            new IllegalStateException(y2.e(this, new StringBuilder("")));
        }
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(y2.e(this, new StringBuilder("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(y2.e(this, new StringBuilder("Trying to set fast scroller without both required drawables.")));
        }
        ...
        if (layoutManager != this.mLayout) {
            ...
            if (layoutManager != null) {
                if (layoutManager.mRecyclerView == null) {
                    ...
                    throw new IllegalArgumentException(y2.e(layoutManager.mRecyclerView, sb));
                }
            }
            this.mRecycler.updateViewCacheSize();
            requestLayout();
