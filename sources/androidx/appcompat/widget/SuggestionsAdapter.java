...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    /* JADX WARNING: Unknown top exception splitter block from list: {B:4:0x0011=Splitter:B:4:0x0011, B:22:0x0045=Splitter:B:22:0x0045, B:16:0x003c=Splitter:B:16:0x003c} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r6) {
        /*
            r5 = this;
            java.lang.String r0 = "Failed to open "
            java.lang.String r1 = "Resource does not exist: "
            r2 = 0
            java.lang.String r3 = r6.getScheme()     // Catch:{ FileNotFoundException -> 0x005b }
            java.lang.String r4 = "android.resource"
            boolean r3 = r4.equals(r3)     // Catch:{ FileNotFoundException -> 0x005b }
            if (r3 == 0) goto L_0x0028
            android.graphics.drawable.Drawable r6 = r5.getDrawableFromResourceUri(r6)     // Catch:{ NotFoundException -> 0x0016 }
            return r6
        L_0x0016:
            java.io.FileNotFoundException r0 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x005b }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x005b }
            r3.<init>(r1)     // Catch:{ FileNotFoundException -> 0x005b }
            r3.append(r6)     // Catch:{ FileNotFoundException -> 0x005b }
            java.lang.String r1 = r3.toString()     // Catch:{ FileNotFoundException -> 0x005b }
            r0.<init>(r1)     // Catch:{ FileNotFoundException -> 0x005b }
            throw r0     // Catch:{ FileNotFoundException -> 0x005b }
        L_0x0028:
            android.content.Context r1 = r5.mProviderContext     // Catch:{ FileNotFoundException -> 0x005b }
            android.content.ContentResolver r1 = r1.getContentResolver()     // Catch:{ FileNotFoundException -> 0x005b }
            java.io.InputStream r1 = r1.openInputStream(r6)     // Catch:{ FileNotFoundException -> 0x005b }
            if (r1 == 0) goto L_0x0049
            android.graphics.drawable.Drawable r0 = android.graphics.drawable.Drawable.createFromStream(r1, r2)     // Catch:{ all -> 0x0040 }
            r1.close()     // Catch:{ IOException -> 0x003c }
            goto L_0x003f
        L_0x003c:
            r6.toString()     // Catch:{ FileNotFoundException -> 0x005b }
        L_0x003f:
            return r0
        L_0x0040:
            r0 = move-exception
        ...
        L_0x0048:
            throw r0     // Catch:{ FileNotFoundException -> 0x005b }
        L_0x0049:
            java.io.FileNotFoundException r1 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x005b }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x005b }
            r3.<init>(r0)     // Catch:{ FileNotFoundException -> 0x005b }
            r3.append(r6)     // Catch:{ FileNotFoundException -> 0x005b }
            java.lang.String r0 = r3.toString()     // Catch:{ FileNotFoundException -> 0x005b }
            r1.<init>(r0)     // Catch:{ FileNotFoundException -> 0x005b }
            throw r1     // Catch:{ FileNotFoundException -> 0x005b }
        L_0x005b:
            r0 = move-exception
