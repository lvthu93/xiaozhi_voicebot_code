...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public void addRetainedFragment(@NonNull Fragment fragment) {
        if (isStateSaved()) {
            ...
            y2.w("Updating retained Fragments: Added ", fragment, TAG);
        }
    }
    ...
    public void attachFragment(Fragment fragment) {
        ...
        if (fragment.mDetached) {
            ...
            if (!this.mAdded.contains(fragment)) {
                if (DEBUG) {
                    y2.w("add from attach: ", fragment, TAG);
                }
                synchronized (this.mAdded) {
                    this.mAdded.add(fragment);
                }
    ...
    public void detachFragment(Fragment fragment) {
        if (DEBUG) {
            y2.w("detach: ", fragment, TAG);
        }
        if (!fragment.mDetached) {
            fragment.mDetached = true;
            if (fragment.mAdded) {
                if (DEBUG) {
                    y2.w("remove from detach: ", fragment, TAG);
                }
                synchronized (this.mAdded) {
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        if (!this.mActive.isEmpty()) {
            ...
            for (Fragment next : this.mActive.values()) {
                ...
                if (next != null) {
                    next.dump(x, fileDescriptor, printWriter, strArr);
                }
            }
        }
        ...
        if (arrayList2 != null && (size3 = arrayList2.size()) > 0) {
            ...
            for (int i3 = 0; i3 < size3; i3++) {
                ...
                backStackRecord.dump(x, printWriter);
            }
        }
        synchronized (this) {
    ...
    public void makeActive(Fragment fragment) {
        if (this.mActive.get(fragment.mWho) == null) {
            ...
            if (DEBUG) {
                y2.w("Added fragment to active set ", fragment, TAG);
            }
        }
    }
    ...
    public void makeInactive(Fragment fragment) {
        if (this.mActive.get(fragment.mWho) != null) {
            if (DEBUG) {
                y2.w("Removed fragment from active set ", fragment, TAG);
            }
            for (Fragment next : this.mActive.values()) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:43:0x0084, code lost:
        if (r0 != 3) goto L_0x0428;
     */
    /* JADX WARNING: Failed to insert additional move for type inference */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:141:0x028c  */
    /* JADX WARNING: Removed duplicated region for block: B:147:0x029e  */
    /* JADX WARNING: Removed duplicated region for block: B:258:0x042d  */
    ...
    public void moveToState(androidx.fragment.app.Fragment r17, int r18, int r19, int r20, boolean r21) {
        ...
        L_0x0161:
            ...
            java.lang.String r1 = defpackage.y2.k(r1, r2, r9)
            r0.<init>(r1)
            throw r0
        L_0x0178:
            androidx.fragment.app.FragmentHostCallback r0 = r6.mHost
        ...
        L_0x01c5:
            ...
            java.lang.String r1 = defpackage.y2.h(r1, r7, r2)
            r0.<init>(r1)
        ...
        L_0x01e0:
            ...
            android.content.res.Resources r1 = r17.getResources()     // Catch:{ NotFoundException -> 0x01fb }
            int r2 = r7.mContainerId     // Catch:{ NotFoundException -> 0x01fb }
            java.lang.String r1 = r1.getResourceName(r2)     // Catch:{ NotFoundException -> 0x01fb }
            goto L_0x01fd
        L_0x01fb:
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        throw new IllegalStateException(y2.j("Fragment ", str2, " did not create a view."));
    }
    ...
    public void putFragment(Bundle bundle, String str, Fragment fragment) {
        if (fragment.mFragmentManager != this) {
            throwException(new IllegalStateException(y2.h("Fragment ", fragment, " is not currently in the FragmentManager")));
        }
    ...
    public void removeRetainedFragment(@NonNull Fragment fragment) {
        if (isStateSaved()) {
            ...
            y2.w("Updating retained Fragments: Removed ", fragment, TAG);
        }
    }
        ...
        if (parcelable != null) {
            ...
            if (fragmentManagerState.mActive != null) {
                for (Fragment next : this.mNonConfig.getRetainedFragments()) {
                    if (DEBUG) {
                        y2.w("restoreSaveState: re-attaching retained ", next, TAG);
                    }
                ...
                if (arrayList != null) {
                    ...
                    while (it3.hasNext()) {
                        ...
                        if (fragment3 == null) {
                            throwException(new IllegalStateException(y2.j("No instantiated fragment for (", next3, ")")));
                        }
                        fragment3.mAdded = true;
                        if (DEBUG) {
                            Log.v(TAG, "restoreSaveState: added (" + next3 + "): " + fragment3);
                        }
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    while (true) {
                        ...
                        if (DEBUG) {
                            StringBuilder n = y2.n("restoreAllState: back stack #", i, " (index ");
                            n.append(instantiate2.mIndex);
                            n.append("): ");
                            n.append(instantiate2);
    ...
    public Parcelable saveAllState() {
        ...
        for (Fragment next : this.mActive.values()) {
            if (next != null) {
                if (next.mFragmentManager != this) {
                    throwException(new IllegalStateException(y2.h("Failure saving state: active ", next, " was removed from the FragmentManager")));
                }
        ...
        if (size2 > 0) {
            ...
            while (it.hasNext()) {
                ...
                if (next2.mFragmentManager != this) {
                    throwException(new IllegalStateException(y2.h("Failure saving state: active ", next2, " was removed from the FragmentManager")));
                }
                if (DEBUG) {
        ...
        if (arrayList3 != null && (size = arrayList3.size()) > 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (DEBUG) {
                    StringBuilder n = y2.n("saveAllState: adding back stack #", i2, ": ");
                    n.append(this.mBackStack.get(i2));
                    Log.v(TAG, n.toString());
                }
            }
        }
    ...
    public void popBackStack(int i, int i2) {
        ...
        throw new IllegalArgumentException(y2.f("Bad id: ", i));
    }
