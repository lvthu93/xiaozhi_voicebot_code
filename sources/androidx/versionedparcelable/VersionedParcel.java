...
public abstract class VersionedParcel {
    ...
    public Serializable readSerializable() {
        ...
        try {
            return (Serializable) new InputStreamRetargetInterface(new ByteArrayInputStream(readByteArray())) {
            ...
            throw new RuntimeException(y2.j("VersionedParcelable encountered IOException reading a Serializable object (name = ", readString, ")"), e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException(y2.j("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", readString, ")"), e2);
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(y2.j("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
        }
    }
