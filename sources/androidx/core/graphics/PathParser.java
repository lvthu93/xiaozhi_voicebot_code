...
public class PathParser {
    ...
    public static Path createPathFromPathData(String str) {
        ...
        try {
            ...
            throw new RuntimeException(y2.i("Error in parsing ", str), e);
        }
    }
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException(y2.j("error in parsing \"", str, "\""), e);
        }
    }
    ...
    public static class PathDataNode {
            ...
            while (i3 < fArr3.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        int i7 = i2 + 5;
                        Path path3 = path;
                        path3.cubicTo(fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i4], fArr3[i5], fArr3[i6], fArr3[i7]);
                        f17 = fArr3[i6];
                        float f21 = fArr3[i7];
                        float f22 = fArr3[i4];
                        float f23 = fArr3[i5];
                        ...
                        int i40 = i3 + 5;
                        float f34 = fArr3[i40] + f17;
                        int i41 = i3 + 6;
                        float f35 = fArr3[i41] + f18;
                        float f36 = fArr3[i3 + 0];
                        float f37 = fArr3[i3 + 1];
                        float f38 = fArr3[i3 + 2];
                        if (fArr3[i3 + 3] != 0.0f) {
                            z3 = true;
                        } else {
                            z3 = false;
                        ...
                        i2 = i3;
                        float f39 = f38;
                        drawArc(path, f17, f18, f34, f35, f36, f37, f39, z3, z4);
                        f = f17 + fArr3[i40];
                        f2 = f18 + fArr3[i41];
                    }
                    i3 = i2 + i;
                    ...
                    int i43 = i2 + 6;
                    float f43 = fArr3[i43];
                    float f44 = fArr3[i2 + 0];
                    float f45 = fArr3[i2 + 1];
                    float f46 = fArr3[i2 + 2];
                    if (fArr3[i2 + 3] != 0.0f) {
                        z = true;
                    } else {
                        z = false;
                    ...
                    drawArc(path, f41, f40, f42, f43, f44, f45, f46, z, z2);
                    f = fArr3[i42];
                    f2 = fArr3[i43];
                }
                f14 = f18;
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d19 != 0.0d) {
                ...
                double d24 = d * d9;
                Path path2 = path;
                arcToBezier(path2, (d23 * cos) - (d24 * sin), (d24 * cos) + (d23 * sin), d7, d9, d5, d11, radians, atan2, atan22);
            }
        }
