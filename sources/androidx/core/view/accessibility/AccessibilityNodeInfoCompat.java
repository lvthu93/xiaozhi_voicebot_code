...
public class AccessibilityNodeInfoCompat {
    ...
    public TouchDelegateInfoCompat getTouchDelegateInfo() {
        AccessibilityNodeInfo.TouchDelegateInfo f;
        if (Build.VERSION.SDK_INT < 29 || (f = this.mInfo.getTouchDelegateInfo()) == null) {
            return null;
        }
        return new TouchDelegateInfoCompat(f);
    }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public AccessibilityNodeInfoCompat getTargetForRegion(@NonNull Region region) {
            ...
            if (Build.VERSION.SDK_INT < 29 || (g = this.mInfo.getTargetForRegion(region)) == null) {
                return null;
            }
            return AccessibilityNodeInfoCompat.wrap(g);
        }
