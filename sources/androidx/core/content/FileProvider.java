...
public class FileProvider extends ContentProvider {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(str, MqttTopic.TOPIC_LEVEL_SEPARATOR)).build();
                }
                throw new IllegalArgumentException(y2.i("Failed to find configured root that contains ", canonicalPath));
            } catch (IOException unused) {
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(y2.i("Invalid mode: ", str));
    }
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) throws IOException, XmlPullParserException {
        ...
        if (resolveContentProvider != null) {
            ...
            throw new IllegalArgumentException(y2.i("Couldn't find meta-data for provider with authority ", str));
        }
    }
