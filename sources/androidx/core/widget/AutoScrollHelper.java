...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    public static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            return (AutoScrollHelper.constrain(((float) (j - j3)) / ((float) this.mEffectiveRampDown), 0.0f, (float) AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY) * f) + (AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY - f);
        }
