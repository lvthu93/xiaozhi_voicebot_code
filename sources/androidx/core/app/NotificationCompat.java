    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x00ab:
                ...
                int r13 = androidx.core.R.id.f5info
            ...
            L_0x00da:
                ...
                int r1 = androidx.core.R.id.f5info
                androidx.core.app.NotificationCompat$Builder r2 = r12.mBuilder
                int r2 = r2.mNumber
                long r2 = (long) r2
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i4 = 0; i4 < remoteInputs.length; i4++) {
                ...
                remoteInputArr2[i4] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i3, remoteInput.getExtras(), (Set<String>) null);
            }
        ...
        if (i5 < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i6, z4, z2);
        }
        if (action.getIcon() == null && (i2 = action2.icon) != 0) {
            return new Action(i2, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i6, z4, z2);
        }
        if (action.getIcon() != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(action.getIcon());
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z3, i6, z4, z2);
    }
