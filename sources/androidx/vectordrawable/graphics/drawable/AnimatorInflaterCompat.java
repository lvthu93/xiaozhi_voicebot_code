...
public class AnimatorInflaterCompat {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        if (objArr != null && objArr.length != 0) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                StringBuilder n = y2.n("Keyframe ", i, ": fraction ");
                Object obj2 = "null";
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (z) {
            if (i == 0) {
                keyframe = Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser, ES6Iterator.VALUE_PROPERTY, 0, 0.0f));
            } else if (i == 1 || i == 3) {
                keyframe = Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, ES6Iterator.VALUE_PROPERTY, 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i == 0) {
